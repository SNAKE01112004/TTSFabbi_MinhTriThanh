...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/Rate/rate.css">
        ...
        <div class="main-second-top">
            ...
            <table>
                ...
                <c:forEach items="${rateList}" var="rate">
                    <tr>
                        <td><a href="/rate/viewValue">${rate.usersId.usersName}</a></td>
                        <td>${rate.usersId.usersPhone}</td>
                        <td>${rate.coursesIsd.coursesName}</td>
                        <td>Tiêu đề</td>
                        <td>Thời gian</td>
                        <td>${rate.rateStatus}</td>
                        <td>${rate.isShow}</td>
                        <td>${rate.rateComment}</td>
                        <td>---</td>
                        <td>----</td>
                    </tr>
                </c:forEach>

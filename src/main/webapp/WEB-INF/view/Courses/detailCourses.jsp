...
<div class="container">
                ...
                <div class="info-section">
                    ...
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-content" id="coursesType">${courses.coursesType == true ? 'Vip' : 'Thường'}</span>
                        </div>
                        <div class="info-item">
    ...
    <div class="modal">
        <div class="modal-content">
            ...
            <input type="text" class="modal-input" placeholder="Tiêu đề chương học">
            <div>
                <button class="btn cancel">Hủy</button>
                <button class="btn create">Tạo</button>
            </div>
        </div>
    </div>
</div>

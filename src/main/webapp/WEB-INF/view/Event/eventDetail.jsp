        ...
        <div class="navigation">
            ...
            <div class="sidebar">
                <ul>
                    ...
                    <li class="sidebar-content">
                        <a href="/event">
                            <span class="/event"><i class="fa-regular fa-calendar-check"></i></span>
        ...
        <div class="main-second-top">
            <div class="checkin-container">
                <div class="checkin-header">
                    <h2 class="checkin-header-title">Danh sách học viên check-in tại sự kiện</h2>
                </div>
                <div class="checkin-actions">
                    <div class="checkin-search-bar">
                        <input type="text" class="checkin-search-input" placeholder="Tìm kiếm theo tên học viên, số điện thoại, email">
                    </div>
                    <button class="checkin-export-button"><i class="fas fa-file-excel"></i> Xuất file excel</button>
                </div>
                        ...
                        <tbody>
                            <c:forEach items="${listUsers}" var="users">
                                <tr>
                                    ...
                                    <td>+84974366323</td>
                                    <td>-</td>
                                    <td>0974366323@gmail.com</td>
                                    <td><span class="checkin-status">Chưa check-in</span></td>
                                    <td>-</td>
                                    <td>-</td>
                                    <td>Ngọc Trần Thị</td>
                                </tr>
